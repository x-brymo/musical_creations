...
import 'package:musical_creations/model/audio_file_model.dart';
import 'package:musical_creations/view/player/player_page.dart';
...
class ListViewFiles extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() => controller.audioFiles.isEmpty ?const Expanded(
      child: Center(
        child: SizedBox(
          height: 15,
          width: 15,
